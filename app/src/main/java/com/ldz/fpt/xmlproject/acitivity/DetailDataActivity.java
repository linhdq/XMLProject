...
import com.ldz.fpt.xmlproject.adapter.ListBaCangDetailAdapter;
import com.ldz.fpt.xmlproject.adapter.ListDeDetailAdapter;
import com.ldz.fpt.xmlproject.adapter.ListLoDetailAdapter;
import com.ldz.fpt.xmlproject.adapter.ListLoXien2DetailAdapter;
import com.ldz.fpt.xmlproject.adapter.ListLoXien3DetailAdapter;
import com.ldz.fpt.xmlproject.adapter.ListLoXien4DetailAdapter;
...
import com.ldz.fpt.xmlproject.model.DeModel;
import com.ldz.fpt.xmlproject.model.LoModel;
        ...
        if (bundle != null) {
            ...
            switch (type) {
                case AdminHomeFragment.TYPE_DE:
                    ...
                    txtNumberDe.setText(String.format("Số: %d", number));
                ...
                case AdminHomeFragment.TYPE_BA_CANG:
                    ...
                    txtNumberBaCang.setText(String.format("Số: %d", number));
                ...
                case AdminHomeFragment.TYPE_LO:
                    ...
                    txtNumberLo.setText(String.format("Số: %d", number));
                    ...
                    txtPointLo.setText(String.format("Tổng điểm: %.1f\nTổng tiền: %s", point,
                            currencyFormatter.format(point * preferenceUtil.getLoPrice())));
                ...
                case AdminHomeFragment.TYPE_LO_XIEN_2:
                    ...
                    txtNumberLoXien2.setText(String.format("Số: %d, %d", number1, number2));
                ...
                case AdminHomeFragment.TYPE_LO_XIEN_3:
                    ...
                    txtNumberLoXien3.setText(String.format("Số: %d, %d, %d", number1, number2, number3));
                ...
                case AdminHomeFragment.TYPE_LO_XIEN_4:
                    ...
                    txtNumberLoXien4.setText(String.format("Số: %d, %d, %d, %d", number1, number2, number3, number4));
