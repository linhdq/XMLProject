...
public class ListLoXien3Adapter extends RecyclerView.Adapter<ListLoXien3Adapter.ViewHolder> {
    private Context context;
    private LayoutInflater inflater;
    private List<LoXien3Model> list;
    private LoXien3Model model;
    private Locale locale;
    private NumberFormat currencyFormatter;
    private PreferenceUtil preferenceUtil;
    private OnItemClickListener listener;

    public ListLoXien3Adapter(Context context, List<LoXien3Model> list, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_on_list_lo_xien_3, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (list.size() > position && (model = list.get(position)) != null) {
            ...
            holder.txtNumber.setText(String.format("%d, %d, %d", model.getNumber1(), model.getNumber2(), model.getNumber3()));
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onItemClick(position, AdminHomeFragment.TYPE_LO_XIEN_3);
                }
            });
        }
    }
