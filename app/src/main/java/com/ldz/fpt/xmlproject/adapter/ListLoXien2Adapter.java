...
public class ListLoXien2Adapter extends RecyclerView.Adapter<ListLoXien2Adapter.ViewHolder> {
    private Context context;
    private LayoutInflater inflater;
    private List<LoXien2Model> list;
    private LoXien2Model model;
    private Locale locale;
    private NumberFormat currencyFormatter;
    private PreferenceUtil preferenceUtil;
    private OnItemClickListener listener;

    public ListLoXien2Adapter(Context context, List<LoXien2Model> list, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_on_list_lo_xien_2, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (list.size() > position && (model = list.get(position)) != null) {
            ...
            holder.txtNumber.setText(String.format("%d, %d", model.getNumber1(), model.getNumber2()));
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onItemClick(position, AdminHomeFragment.TYPE_LO_XIEN_2);
                }
            });
        }
    }
