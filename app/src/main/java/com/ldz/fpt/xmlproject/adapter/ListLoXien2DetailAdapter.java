...
public class ListLoXien2DetailAdapter extends RecyclerView.Adapter<ListLoXien2DetailAdapter.ViewHolder> {
    private List<LoXien2Model> list;
    private LayoutInflater inflater;
    private Context context;
    private LoXien2Model loModel;

    public ListLoXien2DetailAdapter(Context context, List<LoXien2Model> list) {
        this.list = list;
